...
export class Init1715617134860 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "otp" ("otp" character varying NOT NULL, "user_id" integer NOT NULL, "type" "public"."otp_type_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_89b6214c8f25d6332dc6fc20313" PRIMARY KEY ("otp", "user_id"))`,
        );
        await queryRunner.query(
